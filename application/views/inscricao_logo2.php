...
<script src="<?= base_url() ?>comum/js/animaLogo.js"></script>
<script>
...
<article>
    ...
    <section class="sec_1">
        ...
        <div class="fundo fundo_1">
            <div class="logo">
            	<canvas id="canvas"  width="233" height="193" style="width: 150px;" ></canvas>
                <!--<img src="comum/imgs/logo.png">-->
            </div>
        </div>
            	...
            	<form action="" method="get" data-txt="Parabéns, você esta inscrito.">
                    ...
                    <div class="campos">
                        ...
                        <div class="campo x2 tabela selecao cmp_curso">
                            ...
                            <div class="celula"><input type="text" value="Curso" disabled></div>
                        ...
                        <div class="campo x2 tabela selecao cmp_semestre">
                            ...
                            <div class="celula"><input type="text" value="Semestre" disabled></div>
                            <div class="seta_campo celula"><i class="fa fa-caret-down"></i></div>
                            <div class="opcoes">
                    ...
                    <div class="cont_enviar">
                        ...
                        <a class="enviar left" href="javascript:formulario.prox(<?= $i ?>)">
                            <span>Pular</span>
                        </a>
                    </div>
